    ...
    <div class="brand flex-column-auto" id="kt_brand" kt-hidden-height="65" style="">
        ...
        <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item {{$active_menu == "live" ? 'menu-item-active': ''}}" aria-haspopup="true">
                    <a href="{{route('admin.live.index')}}" class="menu-link">
                        <i class="menu-icon fas fa-video"></i>
                        <span class="menu-text">{{trans('admin.live')}}</span>
                    </a>
                </li>
            </ul>
        </div>
